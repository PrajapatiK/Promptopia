...
```bash
git clone https://github.com/PrajapatiK/Promptopia.git
cd Promptopia
```
...
Assets used in the project can be found [here](https://drive.google.com/file/d/16CLF9nCXHJV3U85ZK3nR89LX2ukshzaI/view?usp=drive_link)